...
class Auth {
  ...
  async signIn(userData) {
    ...
    if (data.user.newUser == true) {
      ...
      //redirect returning/exising user to home page
      (0, _Router.gotoRoute)('/');
    }
  }
...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"PetAPI.js":[function(require,module,exports) {
"use strict";
...
class PetAPI {
  async newPet(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/pets"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _PetAPI = _interopRequireDefault(require("./../../PetAPI"));
...
class HomeView {
  async init() {
    ...
    await this.getPets(); // this.filterPets('price', '40-100')
  }

  async filterPets(field, match) {
    // validation 
    if (!field || !match) return; // get fresh copt of pets

    this.pets = await _PetAPI.default.getPets();
    let filteredPets; //gender
    ...
    if (field == 'price') {
      ...
      const priceRangeEnd = match.split('-')[1]; // console.log(priceRangeStart , priceRangeEnd)
  ...
  handleFilterBtn(e) {
    ...
    const match = e.target.getAttribute("data-match"); // filter pets
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../PetAPI":"PetAPI.js","../../Toast":"Toast.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
class UserAPI {
  ...
  async addFavPet(petId) {
    // validate
    if (!petId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavPet"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding pet to favourites');
    } // convert response payload into json - store as data
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"views/pages/howToAdopt.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js"}],"views/pages/favouritePets.js":[function(require,module,exports) {
"use strict";
...
class FavouritePetsView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n      /*-------------- FILTER SECTION --------------*/\n\n      .filter-menu {\n        display: flex;\n        align-items: center;\n        height: 100px;\n        background: var(--brand-color);\n        margin: -1em;\n        padding-left: 2em;\n        color: white;\n      }\n\n      .filter-menu div{\n        margin-right: 5em;\n      }\n\n      .filter-btn {\n        padding: 0.5em;\n      }\n\n      .clear-filter-btn {\n        position: absolute;\n        right: 0%;\n        transform: translate(-50%, -50%);\n      }\n\n      /* RESPONSIVE - MOBILE ------------------- */\n      @media all and (max-width: 768px){       \n\n      .filter-menu div{\n        margin-right: 1em; \n      }\n\n      .filter-btn {\n        padding: 0;\n        margin-top: 0;\n      }\n      .clear-filter-btn {\n        margin-top: 2em;\n      }\n      }\n    </style>\n      <va-app-header title=\"Favourite Pets\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n\n        <div class=\"filter-menu\" id=\"filter-scroll\">\n\n          <div>\n            <strong> Gender </strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"gender\" data-match=\"Male\" @click=", " >Male</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"gender\" data-match=\"Female\" @click=", " >Female</sl-button>\n          </div>\n          <div>\n            <strong> Type </strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"Cat\" @click=", " >Cat</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"Dog\" @click=", " >Dog</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"type\" data-match=\"Other\" @click=", " >Other</sl-button>\n          </div>\n          <div>\n            <strong> Price </strong>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"0-40\" @click=", " >$0-40</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"40-80\" @click=", " >$40-80</sl-button>\n            <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"80-120\" @click=", " >$80-120</sl-button>\n          </div>\n          <div> \n            <sl-button class=\"clear-filter-btn\" size=\"small\" @click=", "> Clear Filters</sl-button>\n          </div>\n\n        </div>\n\n        <div class=\"pets-grid\">\n        ", "\n        </div>\n        <va-app-footer class=\"va-app-footer\"></va-app-footer>\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.favPets == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n        "])), this.favPets.map(pet => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n          <va-pet class=\"pet-card\"\n              id=\"", "\"\n              name=\"", "\"\n              breed=\"", "\"\n              price=\"", "\"\n              image=\"", "\"\n              gender=\"", "\"\n              age=\"", "\"\n              about=\"", "\"\n              shelterTime=\"", "\"\n              >\n              </va-pet>\n          "])), pet._id, pet.name, pet.breed, pet.price, pet.image, pet.gender, pet.age, pet.about, pet.shelterTime))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new FavouritePetsView();

exports.default = _default;
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js","./../../PetAPI":"PetAPI.js"}],"views/pages/newPet.js":[function(require,module,exports) {
"use strict";
...
class NewPetView {
  ...
  async newPetSubmitHandler(e) {
    ...
    try {
      await _PetAPI.default.newPet(formData);

      _Toast.default.show('Pet Added!');
      ...
      if (radioInputs) radioInputs.forEach(radioInput => radioInput.removeAttribute('checked')); // resert file (image) input
...
var _howToAdopt = _interopRequireDefault(require("./views/pages/howToAdopt"));

var _whyAdopt = _interopRequireDefault(require("./views/pages/whyAdopt"));

var _carePet = _interopRequireDefault(require("./views/pages/carePet"));

var _contact = _interopRequireDefault(require("./views/pages/contact"));

var _favouritePets = _interopRequireDefault(require("./views/pages/favouritePets"));

var _newPet = _interopRequireDefault(require("./views/pages/newPet"));

var _donate = _interopRequireDefault(require("./views/pages/donate"));
...
const routes = {
  ...
  '/donate': _donate.default,
  '404': _.default,
  '/signin': _signin.default,
  '/signup': _signup.default,
  '/profile': _profile.default,
  '/editProfile': _editProfile.default,
  '/howToAdopt': _howToAdopt.default,
  '/whyAdopt': _whyAdopt.default,
  '/carePet': _carePet.default,
  '/contact': _contact.default,
  '/favouritePets': _favouritePets.default,
  '/newPet': _newPet.default
};
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/howToAdopt":"views/pages/howToAdopt.js","./views/pages/whyAdopt":"views/pages/whyAdopt.js","./views/pages/carePet":"views/pages/carePet.js","./views/pages/contact":"views/pages/contact.js","./views/pages/favouritePets":"views/pages/favouritePets.js","./views/pages/newPet":"views/pages/newPet.js","./views/pages/donate":"views/pages/donate.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-pet', class Pet extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  moreInfoHandler() {
    ...
    dialogEl.className = 'pet-dialog'; //  content

    const dialogContent = (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        <style>\n            .wrap {\n                display: flex;\n            }\n            .image {\n                width: 50%;\n            }\n            .image img {\n                width: 100%;\n            }\n            .content {\n                padding-left: 1em;\n                max-width: 550px;\n            }\n\n            .price {\n                font-size: 1.5em;\n                font-weight: bold;\n                color: var(--brand-color);\n            }\n\n            .wrap p strong {\n              color: var(--brand-color);\n            }\n\n            .content h1 {\n              color: var(--brand-color);\n            }\n\n            .content p {\n              line-height: 170%;\n            }\n\n            .content sl-button {\n              margin-right: 30px;\n            }\n\n            .donate p{\n              display: inline-block;\n            }\n            .donate-btn{\n              display: inline-block;\n            }\n\n            .wrap sl-button strong {\n              color: var(--brand-color);\n            }\n            .contact-icon {\n              color: var(--brand-color);\n              display: inline;\n            }\n\n            /* RESPONSIVE - MOBILE ------------------- */\n      @media all and (max-width: 375px){ \n        \n      \n      }\n\n        </style>\n            \n        <div class=\"wrap\">\n            <div class=\"image\">\n                <img src=\"", "/images/pets/", "\" alt=\"", "\" />\n                <div class=\"donate\">\n                  <p> <strong>Help animals like ", " by making a donation</strong></p>\n                  <sl-button class=\"donate-btn\" href=\"/donate\" @click=\"", "\"><strong>Donate Now!</strong></sl-button>\n                </div>\n            </div>\n            <div class=\"content\">\n                <h1>", "</h1>\n                <p>", "</p>\n                <p class=\"price\">$", "</p>\n                <p class=\"gender\"> <strong> Gender: </strong> <span>", "</span></p>\n                <p class=\"age\"> <strong> Age: </strong> <span>", "</span></p>\n                <p class=\"about\"> <strong> About: </strong> <span>", "</span></p>\n                <p>Updated: ", "</p>\n\n                <sl-button @click=", ">\n                <sl-icon slot=\"prefix\" name=\"heart-fill\"></sl-icon>\n                Add to Favourites\n                </sl-button>\n\n                <div class=\"contact-icon\">\n                  <sl-icon name=\"envelope-open\"></sl-icon>\n                  <a href=\"/contact\" @click=\"", "\"> <strong>Enquire about adopting ", "</strong></a>\n                </div>\n            </div>\n        </div>\n    "])), _App.default.apiBase, this.image, this.name, this.name, this.menuClick, this.name, this.breed, this.price, this.gender, this.age, this.about, (0, _moment.default)(this.createdAt).format('MMMM Do YYYY'), this.addFavHandler.bind(this), this.menuClick, this.name);
    (0, _litHtml.render)(dialogContent, dialogEl); //appeand 

    document.body.append(dialogEl); // show

    dialogEl.show(); // on hide, delete element
  ...
  async addFavHandler() {
    try {
      _UserAPI.default.addFavPet(this.id);

      _Toast.default.show('Pet added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
  ...
  render() {
    return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <style>\n        .front-card h4{\n            font-weight: normal;\n        }\n\n        .front-card h2 {\n          color: var(--brand-color);\n        }\n    \n    </style>\n    \n    <sl-card class=\"front-card\"> \n        <img slot=\"image\" src=\"", "/images/pets/", "\" />\n        <h2>", "</h2>\n        <h4>", "</h4>\n        <h4>$", "</h4>\n        <sl-button @click=", " >More Info</sl-button>\n        <sl-icon-button name=\"heart-fill\" label=\"Add to Favourites\" @click=", "></sl-icon-button>\n    </sl-card>\n    "])), _App.default.apiBase, this.image, this.name, this.breed, this.price, this.moreInfoHandler.bind(this), this.addFavHandler.bind(this));
  }

});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js","./../UserAPI":"UserAPI.js","./../Toast":"Toast.js","moment":"../node_modules/moment/moment.js"}],"components/va-app-footer.js":[function(require,module,exports) {
"use strict";
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
// custom components start with a prefix (this example is va)
// styles
// app.init // doesnt run straight away, waits for doc to load its content
document.addEventListener('DOMContentLoaded', () => {
  _App.default.init();
});
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-pet":"components/va-pet.js","./components/va-app-footer":"components/va-app-footer.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
